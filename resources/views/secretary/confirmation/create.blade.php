...
@section('secretary-content')
    <div class="pt-16 min-h-screen bg-gray-50">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <!-- Header -->
            <div class="mb-6">
                <h1 class="text-3xl font-bold text-gray-900">Add New Confirmation Record</h1>
                <p class="text-gray-600 mt-1">Enter the details of the confirmation</p>
            </div>

            <div class="bg-white rounded-lg shadow p-6">
                <form method="POST" action="{{ route('secretary.confirmation.store') }}" class="space-y-6">
                    @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date"
                                    ...
                                    value="{{ old('date_of_confirmation') }}"
                                    required
