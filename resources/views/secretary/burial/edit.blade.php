...
@section('title', 'Edit Death Record')
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-8">
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-800">Edit Death Record</h1>
                        <p class="text-gray-600 mt-2">Update death certificate record</p>
                    </div>
                </div>
            </div>
