...
@section('title', 'Add Wedding Record')
...
<div class="pt-16 min-h-screen bg-gray-50">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900">Add New Wedding Record</h1>
            <p class="text-gray-600 mt-1">Enter the details of the marriage</p>
        </div>

        <div class="bg-white rounded-lg shadow p-6">
            <form method="POST" action="{{ route('secretary.wedding.store') }}" class="space-y-6">
                @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="wife_status"
                                   id="wife_status"
                                   value="{{ old('wife_status') }}"
                                   placeholder="e.g., Spinster"
                                   required
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent">
                            @error('wife_status')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
