        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-8">
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-800">New Baptismal Record</h1>
                        <p class="text-gray-600 mt-2">Create a new baptismal certificate record</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-8">
                <form action="{{ route('secretary.baptismal.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" id="baptism_date" name="baptism_date" value="{{ old('baptism_date') }}" required
                    ...
                    <div>
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="fathers_name" name="fathers_name" value="{{ old('fathers_name') }}" required
                            ...
                            <div>
                                ...
                                <input type="text" id="mothers_name" name="mothers_name" value="{{ old('mothers_name') }}" required
                    ...
                    <div>
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" id="church_name" name="church_name" value="{{ old('church_name', 'SJDPP Church') }}" required
                            ...
                            <div>
                                ...
                                <input type="text" id="sponsor" name="sponsor" value="{{ old('sponsor') }}" required
                            ...
                            <div>
                                ...
                                <input type="text" id="secondary_sponsor" name="secondary_sponsor" value="{{ old('secondary_sponsor') }}"
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" id="priest_name" name="priest_name" value="{{ old('priest_name') }}" required
                    ...
                    <div>
                        ...
                        <div class="grid md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" id="book_number" name="book_number" value="{{ old('book_number') }}" required min="1"
                            ...
                            <div>
                                ...
                                <input type="number" id="page_number" name="page_number" value="{{ old('page_number') }}" required min="1"
                            ...
                            <div>
                                ...
                                <input type="number" id="line_number" name="line_number" value="{{ old('line_number') }}" required min="1"
