    ...
    <div class="pt-16 min-h-screen bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex justify-between items-center mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800">Burial Records</h1>
                    <p class="text-gray-600 mt-2">Manage all burial certificates and records</p>
                </div>
                ...
                <form action="{{ route('secretary.burial.index') }}" method="GET">
                    ...
                    <details class="mt-4">
                        ...
                        <div class="grid md:grid-cols-4 gap-4 mt-4 pt-4 border-t border-gray-200">
                            <!-- Date Range -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Burial Date From</label>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Burial Date To</label>
                            ...
                            <!-- Year Filter -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Burial Year</label>
                            ...
                            <div>
                                ...
                                <select name="sort_by" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent">
                                    ...
                                    <option value="date_of_burial" {{ request('sort_by') == 'date_of_burial' ? 'selected' : '' }}>Burial Date</option>
