        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-8">
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-800">New Death Record</h1>
                        <p class="text-gray-600 mt-2">Create a new death certificate record</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-8">
                <form action="{{ route('secretary.burial.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" id="date_of_death" name="date_of_death" value="{{ old('date_of_death') }}" required
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent">
                                @error('date_of_death')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="date" id="date_of_burial" name="date_of_burial" value="{{ old('date_of_burial') }}" required
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-gray-800 mb-4 pb-2 border-b border-gray-200">
                            <i class="fas fa-cross mr-2 text-purple-600"></i>Death Details
                        </h3>
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="informant" name="informant" value="{{ old('informant') }}" required
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent">
                                @error('informant')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <!-- Place -->
                            <div>
                                <label for="place" class="block text-sm font-medium text-gray-700 mb-2">Place of Death <span class="text-red-500">*</span></label>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" id="presider" name="presider" value="{{ old('presider') }}" required
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent">
                                @error('presider')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
