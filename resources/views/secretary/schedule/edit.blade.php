        ...
        <form method="POST" action="{{ route('secretary.schedule.update', $schedule) }}" class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <label class="relative flex flex-col items-center p-4 border-2 rounded-lg cursor-pointer transition {{ old('sacrament_type', $schedule->sacrament_type) == 'baptismal' ? 'border-blue-500 bg-blue-50 ring-2 ring-blue-200' : 'border-gray-300 hover:border-blue-500' }}">
                        <input type="radio"
                               name="sacrament_type"
                               value="baptismal"
                    ...
                    <label class="relative flex flex-col items-center p-4 border-2 rounded-lg cursor-pointer transition {{ old('sacrament_type', $schedule->sacrament_type) == 'burial' ? 'border-purple-500 bg-purple-50 ring-2 ring-purple-200' : 'border-gray-300 hover:border-purple-500' }}">
                        <input type="radio"
                               name="sacrament_type"
                               value="burial"
                    ...
                    <label class="relative flex flex-col items-center p-4 border-2 rounded-lg cursor-pointer transition {{ old('sacrament_type', $schedule->sacrament_type) == 'confirmation' ? 'border-indigo-500 bg-indigo-50 ring-2 ring-indigo-200' : 'border-gray-300 hover:border-indigo-500' }}">
                        <input type="radio"
                               name="sacrament_type"
                               value="confirmation"
                    ...
                    <label class="relative flex flex-col items-center p-4 border-2 rounded-lg cursor-pointer transition {{ old('sacrament_type', $schedule->sacrament_type) == 'wedding' ? 'border-pink-500 bg-pink-50 ring-2 ring-pink-200' : 'border-gray-300 hover:border-pink-500' }}">
                        <input type="radio"
                               name="sacrament_type"
                               value="wedding"
